...
using OoIHaveThat2._0.Data;
using OoIHaveThat2._0.Models;

namespace OoIHaveThat2._0.Controllers
{
    public class ResponsesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SeekerUserId,OwnerUserId,ToolRequestId,PriceCounterOffer,PriceCounterOfferCounter")] Response response)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SeekerUserId,OwnerUserId,ToolRequestId,PriceCounterOffer,PriceCounterOfferCounter")] Response response)
        {
            if (id != response.Id)
            {
                return NotFound();
